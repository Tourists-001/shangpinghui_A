  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(order, i) in orderList.detailArrayList"
          :key="i"
        >
          <li>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.useDefaultAddress.consignee, //最终收件人的名字
        consigneeTel: this.useDefaultAddress.phoneNum, //最终收件人的手机号
        deliveryAddress: this.useDefaultAddress.fullAddress, //收件人的地址
